...
class WhiteBoxParams:
    def __init__(self, model_path, tokenizer_path=None, template_name=None, benchmark_idx=1, placeholder_token="!", n_tokens=8,
        ...
        self.prompt = load_prompts(benchmark_idx)
        self.target = load_targets(benchmark_idx)
